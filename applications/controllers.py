...
stripe.api_key = 'sk_test_51OwnLmSJy1RCz9F86hsoMQ92Hcc1CfAReJeb9il6pvQwvZFy1x9XXO0vitLvn3Vv3Q7YQasLF7MEgHSZg39N7F3V00DGAu50AP'
    ...
    if "user" in session:
        ...
        if request.method == "POST":
            ...
            if "checkout" in request.form:
                # Checkout logic
                return redirect("https://buy.stripe.com/test_cN2eYe1JM6xG9l69AA")
